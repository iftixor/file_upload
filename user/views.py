...
from .serializer import PasswordResetVerifiedSerializer
from .serializer import PasswordChangeSerializer
from .serializer import UserSerializer

# from .serializer import VerifyEmailSerializer
...
class Signup(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            content = {'company_name': company_name, 'email': email, 'first_name': first_name,
                       'last_name': last_name}
